...
const formData = reactive({
    ...
    completeness: 3,
    detail_conservation_status: 5,
    collection_category: 1,
    ethnic_group: 1,
    technique: 3,
    description: 'Fragmento de pelve, coxal esquerdo, masculino, adulto.',
    observations: '30.10.2025 - provavelmente esta pelve estava associada ao conjunto de sepultamento nº 8454.caixa n. 39.',
